...
class MyGame(ShowBase):
    ...
    def loadBackground(self, imagepath):
        ...
        self.background = OnscreenImage(
            parent=self.render2dp, image=imagepath
    ...
    def createPhotonRing(self):
        ...
        # add all vertices
        circleLines.addConsecutiveVertices(
    ...
    def changeColor(self, col=None):
        ...
        crend = (
            self.peZ.getParticlesNamed("acc disk particles").getRenderer().__repr__()
        )
    ...
    def changeRenderer(self, val, ccol=None):
        ...
        if ccol is None:
            if crend == "SpriteParticleRenderer":
                ccol = (
                    self.peZ.getParticlesNamed("acc disk particles")
                    .getRenderer()
                    .getColor()
                )
            elif crend == "LineParticleRenderer":
